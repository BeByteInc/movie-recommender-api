...
@app.post(f"{root_path}/register", status_code=201)
...
@app.get(f"/{root_path}/get_movie_by_id", response_model=Result)
...
@app.get(f"/{root_path}/get_top_rated_movies", response_model=Result)
...
@app.get(f"/{root_path}/get_top_rated_movies_by_genre_name", response_model=Result)
...
@app.get(f"/{root_path}/search_by_title_all_data", response_model=Result)
...
@app.get(f"/{root_path}/search_by_title_with_genre_name", response_model=Result)
...
@app.get(f"/{root_path}/recommend", response_model=Result)
...
@app.post(f"/{root_path}/recommend_by_genre_names", response_model=Result)
...
@app.post(f"/{root_path}/set_user_favorites")
...
@app.post(f"/{root_path}/add_to_user_favorites")
...
@app.post(f"/{root_path}/remove_from_user_favorites")
